...
const Authentication = () => {
  return (
    <div className="flex justify-center items-center h-full p-4 sm:p-6">
      <div className="bg-[#1e293b] p-6 rounded-lg shadow-lg max-w-4xl my-5 w-full border border-[#334155]">
        ...
        <div className="text-[#e2e8f0] mb-4">
          ...
          <span className="text-sm bg-[#374151] p-2 rounded-md">
        ...
        <div className="mb-4">
          ...
          <button className="mt-3 bg-[#22d3ee] text-black font-bold px-4 py-2 rounded">
            Generate API Key
          </button>
        </div>
        ...
        <div className="text-[#e2e8f0] flex items-center">
          ...
          <span className="font-bold bg-[#374151] p-2 rounded-md">
            Generated API Key
          </span>
        </div>
      </div>
